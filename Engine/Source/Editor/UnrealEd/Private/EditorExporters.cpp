...
namespace MaterialExportUtils
{
	...
	{
		return FMaterialUtilities::ExportLandscapeMaterial(InLandscape, HiddenPrimitives, OutFlattenMaterial);
	}
	...
	{
		return FMaterialUtilities::CreateTexture(Outer, AssetLongName, Size, Samples, CompressionSettings, LODGroup, Flags, bSRGB, SourceGuidHash);
	}
	...
	{
		return FMaterialUtilities::ExportBaseColor(LandscapeComponent, TextureSize, OutSamples);
	}
}
...
bool UHairWorksExporter::ExportBinary(UObject* Object, const TCHAR* Type, FArchive& Ar, FFeedbackContext* Warn, int32 FileIndex, uint32 PortFlags)
{
	...
	public:
		FStreamWriter(FArchive& Ar)
			:Ar(Ar)
		{}
		virtual int64 write(const void* data, int64 numBytes)
		{

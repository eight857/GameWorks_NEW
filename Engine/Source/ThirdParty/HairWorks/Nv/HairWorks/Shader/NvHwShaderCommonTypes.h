...
#ifndef NV_HW_SHADER_COMMON_TYPES_H
#define NV_HW_SHADER_COMMON_TYPES_H

#ifdef _CPP 
// This include is needed to make the HLSL types interpretable in C++
#	include "NvHwShaderCpp.h"
#endif

/////////////////////////////////////////////////////////////////////////////////////////////
struct NvHw_ShaderAttributes
{
...
struct NvHw_ConstantBuffer
{
	...
	NvHw_Material	defaultMaterial; 

	// noise table
	float4			noiseTable[NOISE_TABLE_SIZE]; // 256 floats
};

#endif // NV_HW_SHADER_COMMON_TYPES_H

...
#ifndef NV_API_HANDLE_H
#define NV_API_HANDLE_H
...
class ApiHandle
{
	NV_DECLARE_CLASS_BASE(ApiHandle);
...
class ConstApiPtr
{
	NV_DECLARE_CLASS_BASE(ConstApiPtr);
...
{
	NV_DECLARE_CLASS(ApiPtr, ConstApiPtr);
...
{
	NV_DECLARE_CLASS(WrapApiHandle, ApiHandle);
		/// Ctor
	template <typename T>
...
#define NV_HW_GET_TYPE(nativeType, nativeSubType, apiSubType) \
	NV_FORCE_INLINE static Int getType(const nativeType*) { return getType(ScopeSubType::nativeSubType); }

#define NV_HW_GET_HANDLE(nativeType, nativeSubType, apiSubType) \
...
#define NV_HW_GET_VALUE_TYPE(nativeType, nativeSubType, apiSubType) \
	NV_FORCE_INLINE static Int getType(const nativeType&) { return getType(ScopeSubType::nativeSubType); }

} // namespace Nv

#endif // NV_API_HANDLE_H

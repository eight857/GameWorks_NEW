...
namespace HairWorksRenderer
{
	...
	BEGIN_UNIFORM_BUFFER_STRUCT(FHairInstanceDataShaderUniform, )	// We would use array of structure instead of array of raw float in future.
		DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER_ARRAY(FVector4, Data, [HairInstanceMaterialArraySize])
		DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER_ARRAY(FVector4, Data1, [HairInstanceMaterialArraySize])
		DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER_ARRAY(FVector4, Data2, [HairInstanceMaterialArraySize])

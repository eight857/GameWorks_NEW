...
IMPLEMENT_SHADER_TYPE(, FHairWorksCopyStencilPs, TEXT("HairWorks"), TEXT("CopyStencilPs"), SF_Pixel);
...
IMPLEMENT_SHADER_TYPE(, FHairWorksSphereVs, TEXT("HairWorks"), TEXT("SphereVs"), SF_Vertex);

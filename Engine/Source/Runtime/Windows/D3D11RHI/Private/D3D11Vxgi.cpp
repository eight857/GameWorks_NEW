...
NVRHI::IRendererInterface* FD3D11DynamicRHI::RHIVXGIGetRendererInterface()
{
	return VxgiRendererD3D11;
}


bool FD3D11DynamicRHI::RHIVXGIIsInitialized()
{
...
void FD3D11DynamicRHI::RHIVXGIReleaseUnmanagedTextures()
{
	VxgiRendererD3D11->releaseUnmanagedTextures();
}

FRHIShader* FD3D11DynamicRHI::GetRHIShaderFromVXGI(NVRHI::ShaderHandle shader) 
{ 
	return VxgiRendererD3D11->getRHIShader(shader);
}

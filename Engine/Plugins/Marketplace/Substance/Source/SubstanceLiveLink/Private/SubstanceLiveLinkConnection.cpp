...
bool FSubstanceLiveLinkConnection::GameThreadTick(float DeltaTime)
{
	...
	if (bRefreshEditorViewport)
	{
		...
		{
			EditorEngine->UpdateSingleViewportClient(GCurrentLevelEditingViewportClient, false, false);
		}
	}
...
TArray<UMaterial*> FSubstanceLiveLinkConnection::GetMeshMaterials(UObject* Mesh) const
{

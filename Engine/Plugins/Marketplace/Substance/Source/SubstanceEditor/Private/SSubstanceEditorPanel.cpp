...
void SSubstanceEditorPanel::ResetThumbnailInputs(SubstanceAir::GraphInstance* Graph)
{
	for (const auto& InputItr : Graph->getInputs())
	{
...
{
	check(Input);
	check(Input->mDesc.mType == Substance_IType_String);
...
TSharedRef<SWidget> SSubstanceEditorPanel::GetInputWidget(SubstanceAir::InputInstanceBase* Input)
{
	...
	case SubstanceAir::Input_Color:
		...
		{
		case SubstanceInputType::Substance_IType_String:

...
struct RenderCallbacks
{
	...
	//! @brief Output computed callback overload
...
struct GlobalCallbacks
{
	...
	//! @brief Accessor on global callbacks (can be NULL: not defined)
...
private:
	//! @brief Current User global callbacks instance (can be NULL, none)

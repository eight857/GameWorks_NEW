...
struct InputDescBase
{
	...
	//! @brief Xml element that contains GUI related information
	//! @deprecated GUI related information is now completely parsed, will be
	//!		eventually removed.
	string mGuiXmlElement;
...
//!  - float     : mType == Substance_IType_Float
//!  - Vec2Float : mType == Substance_IType_Float2
//!  - Vec3Float : mType == Substance_IType_Float3
//!  - Vec4Float : mType == Substance_IType_Float4
//!  - int       : mType == Substance_IType_Integer
//!  - Vec2Int   : mType == Substance_IType_Integer2
//!  - Vec3Int   : mType == Substance_IType_Integer3
//!  - Vec4Int   : mType == Substance_IType_Integer4
//!
...
typedef InputDescNumerical<float>     InputDescFloat;  //!< Substance_IType_Float
typedef InputDescNumerical<Vec2Float> InputDescFloat2; //!< Substance_IType_Float2
typedef InputDescNumerical<Vec3Float> InputDescFloat3; //!< Substance_IType_Float3
typedef InputDescNumerical<Vec4Float> InputDescFloat4; //!< Substance_IType_Float4
typedef InputDescNumerical<int>       InputDescInt;    //!< Substance_IType_Integer
typedef InputDescNumerical<Vec2Int>   InputDescInt2;   //!< Substance_IType_Integer2
typedef InputDescNumerical<Vec3Int>   InputDescInt3;   //!< Substance_IType_Integer3
typedef InputDescNumerical<Vec4Int>   InputDescInt4;   //!< Substance_IType_Integer4
...
//!  - float     : mDesc.mType == Substance_IType_Float
//!  - Vec2Float : mDesc.mType == Substance_IType_Float2
//!  - Vec3Float : mDesc.mType == Substance_IType_Float3
//!  - Vec4Float : mDesc.mType == Substance_IType_Float4
//!  - int       : mDesc.mType == Substance_IType_Integer
//!  - Vec2Int   : mDesc.mType == Substance_IType_Integer2
//!  - Vec3Int   : mDesc.mType == Substance_IType_Integer3
//!  - Vec4Int   : mDesc.mType == Substance_IType_Integer4
template <typename T>
...
typedef InputInstanceNumerical<float>     InputInstanceFloat;  //!< Substance_IType_Float
typedef InputInstanceNumerical<Vec2Float> InputInstanceFloat2; //!< Substance_IType_Float2
typedef InputInstanceNumerical<Vec3Float> InputInstanceFloat3; //!< Substance_IType_Float3
typedef InputInstanceNumerical<Vec4Float> InputInstanceFloat4; //!< Substance_IType_Float4
typedef InputInstanceNumerical<int>       InputInstanceInt;    //!< Substance_IType_Integer
typedef InputInstanceNumerical<Vec2Int>   InputInstanceInt2;   //!< Substance_IType_Integer2
typedef InputInstanceNumerical<Vec3Int>   InputInstanceInt3;   //!< Substance_IType_Integer3
typedef InputInstanceNumerical<Vec4Int>   InputInstanceInt4;   //!< Substance_IType_Integer4
...
bool isFloatType(SubstanceInputType type);
